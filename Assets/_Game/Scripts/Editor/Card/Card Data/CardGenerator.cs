...
namespace DuelMasters.Editor.Data
{
    public class CardGenerator : EditorWindow
    {
                        ...
                        foreach (CardReadDataFormat cardData in cardReadDataList.cards)
                        {
                            ...
                            switch (cardData.type)
                            {
                                case "Spell":
                                    ...
                                    AssetDatabase.CreateAsset(spellData,
                                        CardObjectsPath + $"{setName}/{cardData.name}.asset");
                                    break;
                                case "Creature":
                                case "Evolution Creature":
                                    ...
                                    AssetDatabase.CreateAsset(creatureData,
                                        CardObjectsPath + $"{setName}/{cardData.name}.asset");
                                    break;
                            }
                        }
        ...
        private static CreatureData SetupCreatureCard(CreatureData creatureData, CardReadDataFormat cardReadDataFormat,
            string setName)
        {
