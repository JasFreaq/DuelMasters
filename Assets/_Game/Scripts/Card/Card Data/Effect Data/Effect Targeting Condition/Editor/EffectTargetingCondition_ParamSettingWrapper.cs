...
public static class EffectTargetingCondition_ParamSettingWrapper
{
    ...
    {
        List<EffectTargetingConditionParameter> newParams = ReflectiveEnumerator.GetClassesOfType<EffectTargetingConditionParameter>();
    ...
    private static void PopulateParamListWithMissingTypes(EffectTargetingCondition condition, List<EffectTargetingConditionParameter> newParams)
    {
        Dictionary<string, EffectTargetingConditionParameter> existingParamsMap = new Dictionary<string, EffectTargetingConditionParameter>();
